...
**Course:** EECS447: Database Systems — Fall 2026
...
|---|---|---|---|---|---|
|Connor Eaton |Email:<br>connoreaton1o9@ku.edu |Developer |MWF 12pm-2pm, 3pm-5pm<br>TR 2pm-5pm |Windows, Linux |Python |
|Kegan Firey |Email:<br>keganf01@ku.edu |Team Administrator<br>Developer |MWF 9am-11am<br>WF 1pm-5pm<br>TR 4pm-5pm |Windows |Python, C++ |
|Lydia Peng|Email:<br>lydia64peng@ku.edu |Developer |MWF 9am-1pm, 3pm-5pm<br>R 4pm-5pm |Windows, macOS |Python, C#, C++, HTML, JavaScript, SQL |
|Joseph Ubanda-Ruiz|Email:<br>jubanda@ku.edu |Developer<br>Meeting Notetaker |MWF 1pm-2pm, 3pm-4pm<br>T 12:15pm-4:00pm<br>R 12:15pm-2pm |Windows and macOS |Python, HTML, JavaScript, C, C++ |
...
- [ ] Part 6: Project Demonstration

## 4. Repository Structure
- `docs/` — design documents and deliverables (vision statement, ER diagrams, logical design)
